...
const AdminDashboard = ({ children }) => {
    ...
    const menus = [
        { name: "Dashboard", href: "/dashboard", icon: '<i class="ri-dashboard-line"></i>' },
        { name: "Patients", href: "dashboard/patients", icon: '<i class="ri-group-3-line"></i>' },
        { name: "Appointments", href: "dashboard/appointments", icon: '<i class="ri-file-chart-line"></i>' },
        { name: "Reports", href: "dashboard/reports", icon: '<i class="ri-file-chart-line"></i>' },
        { name: "Settings", href: "/settings", icon: '<i class="ri-settings-line"></i>' },
    ];
                ...
                <nav className="flex flex-col gap-2">
                    {menus?.map((menu, index) => (
                        <Link
                            key={index}
                            href={menu.href}
                            className="py-3 px-3 rounded-md hover:bg-blue-500 transition"
                        >
                            {menu.name}
                        </Link>
                    ))}
